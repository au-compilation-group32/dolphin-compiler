...
let test21: test_case =
  "test21",
  "Positive: Test loop scope and shadowing behavior",
  ...
  [
    VarDeclStm (DeclBlock [Declaration {name = int_i; tp = None; body = Integer {int = 6L}}]);
    VarDeclStm (DeclBlock [Declaration {name = int_j; tp = None; body = Integer {int = 69L}}]);
    VarDeclStm (DeclBlock [Declaration {name = int_k; tp = None; body = Integer {int = 419L}}]);
    ForStm {
      init = Some (FIDecl declar_block_i);
      cond = Some (BinOp{left = Lval (Var int_i); op = Lt; right = Integer {int = 2L}});
      ...
      body = 
        ForStm {
          ...
          cond = Some (BinOp{left = Lval (Var int_j); op = Lt; right = Integer {int = 2L}});
          ...
          body = 
            ForStm {
              ...
              cond = Some (BinOp{left = Lval (Var int_k); op = Lt; right = Integer {int = 2L}});
    ...
    WhileStm {
      cond = BinOp{left = Lval (Var int_i); op = Lt; right = Integer {int = 2L}};
      body = CompoundStm {stms =[
        ForStm {
          init = Some (FIDecl declar_block_j);
          cond = Some (BinOp{left = Lval (Var int_j); op = Lt; right = Integer {int = 2L}});
    ...
    ForStm {
      ...
      body = CompoundStm {stms =[
        ...
        WhileStm {
          cond = BinOp{left = Lval (Var int_j); op = Lt; right = Integer {int = 2L}};
          body = CompoundStm {stms = [
            ForStm {
              init = Some (FIDecl declar_block_k);
              cond = Some (BinOp{left = Lval (Var int_k); op = Lt; right = Integer {int = 2L}});
      ...
      body = 
        ForStm {
          ...
          body = CompoundStm {stms = [
            ...
            WhileStm {
              cond = BinOp{left = Lval (Var int_k); op = Lt; right = Integer {int = 2L}};
              body = CompoundStm {stms = [
                IfThenElseStm {
                  cond = BinOp{left = BinOp {left = Lval (Var int_k); op = Rem; right = Integer {int = 2L}}; op = Eq; right = Integer {int = 0L}};
                  thbr = CompoundStm {stms = [
